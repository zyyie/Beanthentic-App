...
<head>
  ...
  <title>Excelsa · History · Beanthentic</title>
  ...
  <style>
    ...
    .hist-variety-single {
      ...
      box-shadow: 0 10px 28px rgba(13, 77, 43, 0.07);
    }
    .hist-variety-single .about-topic {
...
<body class="has-app-bottom-nav">
  <header class="hist-hero">
    <div class="hist-hero-row">
      ...
      <h1 class="hist-nav-title">Excelsa Beans</h1>
    </div>
  </header>

  <main class="hist-main">
    <div class="about-card hist-variety-single">
                <section id="history-excelsa" class="about-topic hist-variety-topic" aria-label="Excelsa">
                  <div>
                    <span class="hist-badge"><span class="hist-badge-dot" aria-hidden="true"></span> Excelsa</span>
                  </div>
