...
<head>
  ...
  <script>
    // Assets are loaded via file:// in the Android WebView, so PHP redirects won't run here.
    // Redirect immediately in JS instead.
    (function () {
      try {
        window.location.replace('https://www.facebook.com/share/1G6kwxhijL/');
      } catch (e) {}
    })();
  </script>
